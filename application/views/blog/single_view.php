...
?>
    ...
    <div id="single-view" class="span8">
        <ul>
            <li><strong>Author:</strong> <?php echo $posts['post'][0]->username; ?></li>
            <li><strong>Date Posted:</strong> <?php echo date('F d, Y', strtotime($posts['post'][0]->entry_date));?></li>
        </ul>
    </div>
<div class="span8">
    <h4>Comments</h4>
    ...
    <div class="well well-small" id="comment-wrapper">
        <ul>
            ...
            <li><small><?php echo date('F d, Y H:i A', strtotime($posts['blog_comments'][$x]->comment_date));?></small></li>
        </ul>
        <hr />
